...
<div dir="rtl" style="text-align:right; list-style-position: inside;">

<ul>
  <li> \( T \): دمای جسم در لحظه \( t \) </li>
  <li> \( T_{env} \): دمای محیط (ثابت) </li>
  <li> \( k \): ضریب خنک‌شدن (وابسته به شرایط جسم و محیط) </li>
  <li> علامت منفی \(-\): یعنی اگر جسم داغ‌تر از محیط باشد، دما کاهش می‌یابد. </li>
</ul>
